...
urlpatterns = [
    ...
    path('get/<int:post_id>/', views.PostRetrieveDeleteAPIView.as_view(), name='post-getdelete'),
    ...
    path('comment/upload/', views.CommentUploadAPIView.as_view(), name='comment-upload'),
